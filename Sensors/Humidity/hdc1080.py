...
# Modified from driver by @rubenmoral from
...
class HDC1080:
    ...
    def read_humid_temp(self,celsius=True):
        # Wrapper to combine humidity & temp (& change default to Celsius)
        self.humidity=self.read_humidity();
        self.temperature=self.read_temperature(celsius=celsius)
        print('h,t = ',self.humidity,self.temperature)
