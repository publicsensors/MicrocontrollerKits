...
params={'setup_dir':'SetUp',
        ...
        'sensor_log_headers':{'samplenum':'SampleNum',
                       ...
                       'color':{'R':'R','G':'G','B':'B','full':'full'},
                        ...
                        'GPSalt':{'GPStime':'GPStime','dec_lat':'dec_lat','dec_long':'dec_long','altitude':'altitude'},
                        'GPSvel':{'GPStime':'GPStime','dec_lat':'dec_lat','dec_long':'dec_long',
                               'kph':'kph','course':'course'},
        ...
        'sensor_log_formats':{'samplenum':'%d',
                       ...
                       'color':{'R':'%d','G':'%d','B':'%d','full':'%d'},
                        ...
                        'GPS':{'GPStime':'%4d-%02d-%02dT%02d-%02d-%02d','dec_lat':'%f','dec_long':'%f','altitude':'%f',
                               'kph':'%f','course':'%f'},
                        'GPSalt':{'GPStime':'%4d-%02d-%02dT%02d-%02d-%02d','dec_lat':'%f','dec_long':'%f','altitude':'%f'},
                        'GPSvel':{'GPStime':'%4d-%02d-%02dT%02d-%02d-%02d','dec_lat':'%f','dec_long':'%f',
                               'kph':'%f','course':'%f'},
                        'AQI':{'PM25':'%f','PM10':'%f'},
                        'CO2':{'ppm':'%f','temp':'%f'},
